...
a. sem espaço entre palavras
    - *paste(x,"Computacional",sep="")* $$`r paste(x,"Computacional",sep="")`$$

b. outros separadores entre palavras 
    - *paste(x,"Computacional",sep=";")* $$`r paste(x,"Computacional",sep=";")`$$
...
## Solução_5.02
2. Usando o vetor do item 01. Quantos dias úteis tem o mês de setembro no referido ano?
```{r}
...
## Solução_5.03
3. Construa um programa para calcular o tempo, em dias, de uma data de referencia até o dia de hoje. Quantos dias se passaram do Mundial da Russia (15 de julho de 2018)? Quantos dias faltam para o Mundial do Catar (21/11/2022)?
```{r}
