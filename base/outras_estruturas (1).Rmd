...
## Exercícios Continuação {#Exercícios_03.1}
...
## Solução_3.05
5. Crie uma matriz de 2 linhas e 3 colunas com letras e coloque-a (substitua) no centro da matriz do item 2. O que aconteceu com a matriz? 
```{r}
